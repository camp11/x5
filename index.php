...
$channelAccessToken = 'IoV+drwOO7yfFSYh/4bNnrm4NSeP7UJI8Rqga1MTApZK7YWv89ZnjZKna01nMo0+89lkm8k/skVX7Nq9mVpGele45+eDTfi0JBuY06txHLFpLEATPI0MYFs35+b10ZP4JJ3oFyI2PcpKMzuw7eBptQdB04t89/1O/w1cDnyilFU='; //sesuaikan 
$channelSecret = '6a4e98f21c52a4caf2acbd0e8640ce8b';//sesuaikan
...
if($message['type']=='text') {
  ...
  array (
    ...
    array (
      0 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532253466/SAS/admin/1532252753993.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      1 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532317265/SAS/admin/1532316997663.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      2 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532253901/SAS/admin/1532253830686.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      3 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532253473/SAS/admin/1532252687527.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      4 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532253517/SAS/admin/1532252711377.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      5 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532253482/SAS/admin/1532252666042.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
      ...
      6 => 
      array (
        'imageUrl' => 'https://res.cloudinary.com/dmvpko25b/image/upload/v1532254096/SAS/admin/1532252627464.jpg',
        'action' => 
        array (
          'type' => 'uri',
          'label' => 'SMULE',
...
if($message['type']=='text') {
  ...
  'altText' => 'SAS BOT mengirim sticker',
  'baseSize' => 
  array (
    'height' => 1040,
    'width' => 1040,
